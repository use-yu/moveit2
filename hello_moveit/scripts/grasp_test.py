...
PLACE_JOINTS = {
    ...
    "right_arm": {
        ...
        "yubei": {
            "sw1": [
                0.0, 0*math.pi/180,
                -2.730788875+2*math.pi,1.070762582,2.024272804,0.061451719,0.421045443,-2.311431579
            ],
            "sw2": [
                0.0, 0*math.pi/180,
                -2.732561891+2*math.pi,1.534342363,1.711300275,-0.084688101,0.416122700,-2.316281197
            ],
            "sw3": [
                0.0, 0*math.pi/180,
                -2.868951157+2*math.pi,1.580940513,1.200493822,0.379301392,0.278972408,-2.314956351
            ],
            "sw4": [
                0.0, 0*math.pi/180,
                -2.868557065+2*math.pi,1.166127840,1.507164418,0.482933940,0.281924882,-2.310275025
            ],            
            
        },
        "fang": {
            "sw1": [
                -2.504955870+2*math.pi,1.109081905,1.736123018,0.303090156,0.646312845,-2.303681354
            ],
            "sw2": [
                -2.505861803+2*math.pi,1.540089386,1.437786776,0.172629209,0.642671445,-2.306420647
            ],
            "sw3": [
                -2.685923387+2*math.pi,1.665536404,0.886602238,0.597581451,0.460649861,-2.304245791
            ],
            "sw4": [
                -2.686097667+2*math.pi,1.254047523,1.228780989,0.665440242,0.463087479,-2.302626684
            ],
        },
    },
    "left_arm": {
