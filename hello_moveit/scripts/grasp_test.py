...
NAV_GOAL_POSES = {
    ...
    NAV_TARGET_GRASP: {
        "position": (
            2.0505805015563965,
            0.0969683825969696,
            -0.014873062260448933,
        ),
        "orientation": (
            0.00039914611261337996,
            0.02196754701435566,
            -0.013393161818385124,
            0.9996967315673828,
        ),
    },
    NAV_TARGET_PLACE: {
        ...
        "orientation": (
            -0.000984888756647706,
            0.02201298624277115,
            -0.001252052141353488,
            0.9997838139533997,
        ),
    },
    NAV_TARGET_INIT: {
        ...
        "orientation": (
            0.0028479185421019793,
            0.019094645977020264,
            -0.021404169499874115,
            0.9995894432067871,
        ),
    },
}
...
PLACE_JOINTS = {
    ...
    "right_arm": {
        "yubei_j": {
            "sw1": [
                0.0, 0*math.pi/180,
                3.541520693,1.046481216,2.029594249,0.081453837,0.410053200,-2.301581397
            ],
            "sw2": [
                0.0, 0*math.pi/180,
                3.542824651,1.521461911,1.718438376,-0.088556846,0.415381944,-2.294780222
            ],
            "sw3": [
                0.0, 0*math.pi/180,
                3.407942809,1.577249339,1.184360876,0.407220037,0.281645825,-2.314310538
            ],
            "sw4": [
                0.0, 0*math.pi/180,
                3.408148874,1.156090132,1.489273296,0.529687718,0.278687656,-2.32079562
            ],

        },
        "fang_j": {
            "sw1": [
                3.767010481,1.088926574,1.744917444,0.322254074,0.636285978,-2.298628322
            ],
            "sw2": [
                3.767399680,1.529521057,1.446811247,0.176685027,0.640113695,-2.294762175
            ],
            "sw3": [
                3.587365032,1.665214677,0.869512422,0.628169791,0.462824713,-2.307288055
            ],
            "sw4": [
                3.588237591,1.245398701,1.215921664,0.703608405,0.460424262,-2.309556659
            ],
        },
        "yubei": {
            "sw1": [
...
class G01Demo(Node):
    ...
    def _plan_exchange_trajectories(
        ...
        *,
        ...
        # 统一减慢交换运动，覆盖后台预规划和现场重规划；退回复用反向直线轨迹。
        dual_speed *= 0.5
        cartesian_speed *= 0.5
