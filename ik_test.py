...
# 1
# TARGET_XYZ = [-0.143947409, -0.086357646, 0.75547267]
# TARGET_RPY = [-178.690052, 0.649431, 41.176008]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

# TARGET_XYZ = [-0.143947409, -0.086357646+0.17, 0.75547267]
# TARGET_RPY = [-178.690052, 0.649431, 41.176008]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

# TARGET_XYZ = [-0.143947409-0.17, -0.086357646+0.17, 0.75547267]
# TARGET_RPY = [-178.690052, 0.649431, 41.176008]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

TARGET_XYZ = [-0.143947409-0.17, -0.086357646, 0.75547267]
TARGET_RPY = [-178.690052, 0.649431, 41.176008]
SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]
# 左臂放
# TARGET_XYZ = [-0.431223813, 0.084130737, 0.523330142]
# TARGET_RPY = [180, 0.0, 43.201653]
# SEED_JOINTS = [154.0, -89.0, -91.0, -2.0, -25.0, 42.0]

#1
# TARGET_XYZ = [-0.1325, -0.085+0.0015, 0.654]
# TARGET_RPY = [180, 0.0, 41]
# SEED_JOINTS = [154.0, -89.0, -91.0, -2.0, -25.0, 42.0]

# TARGET_XYZ = [-0.1325, -0.085+0.17+0.001, 0.654]
# TARGET_RPY = [180, 0.0, 41]
# SEED_JOINTS = [154.0, -89.0, -91.0, -2.0, -25.0, 42.0]

# TARGET_XYZ = [-0.1325-0.17, -0.085+0.17+0.002, 0.754]
# TARGET_RPY = [180, 0.0, 40]
# SEED_JOINTS = [154.0, -89.0, -91.0, -2.0, -25.0, 42.0]

# TARGET_XYZ = [-0.1325-0.17, -0.085+0.002, 0.654]
# TARGET_RPY = [180, 0.0, 41]
# SEED_JOINTS = [154.0, -89.0, -91.0, -2.0, -25.0, 42.0]
# 交换右
