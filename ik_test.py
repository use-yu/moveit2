...
# 1
TARGET_XYZ = [-0.127, -0.084, 0.653]
TARGET_RPY = [-180, 0.0, 42.0]
SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

# TARGET_XYZ = [-0.127, -0.084+0.17, 0.653]
# TARGET_RPY = [-180, 0.0, 43.0]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

# TARGET_XYZ = [-0.127-0.17, -0.084+0.17, 0.653]
# TARGET_RPY = [-180, 0.0, 43.0]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]

# TARGET_XYZ = [-0.127-0.17, -0.084, 0.653]
# TARGET_RPY = [-180, 0.0, 43.0]
# SEED_JOINTS = [216.8105,62.8939,100.5533,16.9322,37.3706,-132.9887]
# 左臂放
